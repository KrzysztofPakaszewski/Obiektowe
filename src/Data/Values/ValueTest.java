...
class ValueTest {
    ...
    void toStringTests(){
        ...
        DateTimeValue tmp9 = new DateTimeValue("1999 10 16 10:11:07");
        assertEquals("25",tmp.toString());
        assertEquals("5.0",tmp4.toString());
        assertEquals("lkjwnf",tmp7.toString());
        assertEquals("1999 10 16 10:11:07",tmp9.toString());
    }
    @Test
    void calculatingTest(){
        ...
        assertEquals("3.141600074768067",tmp2.mul(tmp3).toString());
